...
function Header() {
  ...
  dark:supports-[backdrop-filter]:before:from-background/100
  dark:supports-[backdrop-filter]:before:via-background/80
  dark:supports-[backdrop-filter]:before:to-background/60
  supports-[backdrop-filter]:before:from-background/80
  supports-[backdrop-filter]:before:via-background/60
  supports-[backdrop-filter]:before:to-background/50
