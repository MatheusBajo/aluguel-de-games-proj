import {CarouselLanding, CarouselContent, CarouselItem, useCarousel} from "../../components/ui/carousel-landing.tsx";
...
import FlyingEmoji from "../../components/hooks/FlyingEmojis.tsx";
...
function Main() {
    ...
    return (
        <main className="flex flex-col gap-10 pt-5 mx-auto w-full">
            {/* =============== SECTION 1: CAROUSEL =============== */}
